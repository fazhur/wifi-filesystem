...
namespace Settings
{
    String SSID = "TP-LINK_9EBA";
    String SSIDPassword = "92814035";
    String remote_server = "192.168.0.101";
        ...
        if (client.available()) {
            ...
            if (client.readBytes((byte*)&answer, sizeof(answer)) == sizeof(answer)) {
                ...
                if (psram) {
                    ...
                    Serial.print("clusters_count: ");
                    Serial.println(answer.clusters_count);
                    Serial.print("fat_first_sector: ");
                    Serial.println(answer.fat_first_sector);
                    Serial.print("files_count: ");
                    Serial.println(answer.files_count);
                    Serial.print("sectors_count: ");
                    Serial.println(answer.sectors_count);
                    ...
                    Serial.print("psram_file_sectors.buffer: ");
                    Serial.println((uint32_t)psram_file_sectors.buffer);
                }
